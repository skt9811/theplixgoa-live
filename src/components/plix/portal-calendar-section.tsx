...
/**
 * The full calendar + tap-to-inspect-a-date + Block Dates surface, shared
 * between the Dashboard tab's preview and the standalone Calendar tab so
 * neither has to duplicate the drawer/modal/back-button wiring.
 */
export function PortalCalendarSection({ propertySlug, bookings }: { propertySlug: string; bookings: PortalBooking[] }) {
