...
export const Route = createFileRoute("/privacy")({
  head: () => {
    ...
    const description =
      "Learn how The Plix Goa collects, uses, and safeguards your personal data in compliance with IT Act 2000 and GDPR guidelines for luxury villa reservations.";
    return {
      meta: [
        { title },
